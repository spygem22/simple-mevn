   ...
   <v-row no-gutters>
     ...
     <v-card-title>Add New</v-card-title>
      ...
      <v-form ref = "form" @submit.prevent="submitForm" class = "pa-5" enctype="multipart/form-data">
       ...
       <v-file-input @change="selectFile" show-size counter multiple :rules = "rules" label = "Select Image"></v-file-input>

       <v-btn type ="submit" class = "mt-3" color = "primary">Add New</v-btn>
      </v-form>
     </v-card>
     </v-col>
   </v-row>
